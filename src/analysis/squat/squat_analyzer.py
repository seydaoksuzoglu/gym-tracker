...
from src.analysis.squat.squat_features import extract_squat_features
...
from src.analysis.squat.squat_counter import SquatCounter
from src.analysis.squat.squat_rules import SquatRules
