    ...
    for idx, video_path in enumerate(video_files):
        ...
        while cap.isOpened():
            ...
            if key == ord('q'):
                ...
                current_rep["labels"]["incomplete_lockout"] = 0
...
if __name__ == "__main__":
    ...
    klasor_yolu = os.path.join(project_root, "data", "squat", "videos")
    output_root = os.path.join(project_root, "data", "squat", "video_labels")
